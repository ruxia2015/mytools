    ...
    <div class="col-sm-8">
        ...
        <div style="margin-top: 10px;padding-top:20px;" class="card">
           <iframe id="showFrame" width="100%" height="900px" style="overflow-x: auto;border: 0px;"></iframe>
            <%--<jsp:include page="testUnitBody.jsp"/>--%>
        </div>
    </div>
...
<script>
    ...
    function openTabFun(name,uuid){
        ...
        $("#showFrame").attr("src","${pageContext.request.contextPath}/manager/toUpdateTestUnitBody.action?uuid="+uuid);
...
/*    $(function () { $('#two_0').collapse('show')});
    $(function () { $('#three_0_0').collapse('show')});*/
